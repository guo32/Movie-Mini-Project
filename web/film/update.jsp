...
<div class="container-fluid">
    <div class="container">
        ...
        %>
        <form action="/film/update_logic.jsp?id=${film.id}" method="post" enctype="multipart/form-data" name="registerForm">
                            ...
                            <div class="col-12">
                                <table class="col-12">
                                    <tr>
                                        ...
                                        <td><input type="text" name="director" id="director" value="${film.director}"
