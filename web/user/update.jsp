        ...
        <div class="row my-5 align-items-center">
            <div class="row justify-content-center">
                <div class="col-6" style="background-color: #F2F2F2; border-radius: 1em;">
                    <form action="/user/update_logic.jsp" method="post" name="updateForm" id="update-form">
                        ...
                        <div class="row justify-content-center mb-2">
                            <div class="col-10">
                                <div class="form-floating" id="div-for-new-password">
                        ...
                        <div class="row justify-content-center mb-2">
                            <div class="col-10">
                                <div class="form-floating" id="div-for-old-password">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10 text-center">
                                <div class="btn btn-outline-primary col-5" onclick="submitForm()">수정</div>
